...
function NavRow({icon, label, badge, active, onClick, trailing}: NavRowProps) {
    return (
        ...
        >
            ...
            {badge != null && (
                <span
                    className="w-5 h-5 rounded-full bg-grey-100 flex items-center justify-center text-[11px] font-semibold">
          {badge}
        </span>
            )}
            {trailing}
        ...
        <nav className="sv-sidebar">
            <div className="flex flex-col gap-6 self-stretch">
                <div className="relative h-[46px] shrink-0">
                    ...
                    />
                    <span
                        className="absolute left-[36px] top-[34px] w-[104px] text-center text-[10px] font-semibold tracking-[var(--sa-tracking-xs)] text-primary-600">
            TREASURER V6.0.0
          </span>
                </div>
          ...
          */}
                        ...
                        <div className="sv-nav-tree">
                            {dashboards.map((dash) => {
                                ...
                                return (
                                    ...
                                    >
                                        <span
                                            className={"sv-nav-dash" + (active ? " sv-nav-dash--active" : "")}>–</span>
                ...
                <div className="sv-nav-group">
                    <div className="sv-eyebrow">Modules</div>
            ...
            <div className="sv-nav-group shrink-0">
                ...
                <NavRow icon="gear" label="Security Manager"/>
