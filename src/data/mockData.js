...
export const TOP_ACCOUNTS = [...ACCOUNTS].sort((a, b) => b.eur - a.eur).slice(0, 6);

const SYMBOLS = { GBP: "£", EUR: "€", USD: "$", SEK: "kr", DKK: "kr" };
